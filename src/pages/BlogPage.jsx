...
const BlogPage = () => {
  return (
    <section className='px-[1rem] sm:px-[3rem] py-[2rem] md:py-[4rem]'>
    <div className=' flex flex-col gap-[3rem]'>
<h1 className='text-2xl font-bold'>Latest Blog</h1>
<form action="" className='flex gap-5 justify-center'>
  <input type="text" name="search" id="search" placeholder='Search...' 
  className='max-w-[30rem] w-full h-[3rem]     placeholder:text-black/90 border-2 rounded-lg border-black px-3 text-lg focus:outline-none focus:shadow-lg'  />
