...
const Index = () => {
  return (
    <div>
      <section className='h-[70vh] sm:h-[90vh] w-full bg-white  px-1 sm:px-[3rem] rounded-xl '>
...
<h1 className='text-[1.5rem] text-white sm:text-[2rem] md:text-[4rem]  font-extrabold hike'>Desk, Everyone's Desk</h1>
    <p className='text-[1rem] sm:text-xl text-center text-white'>
