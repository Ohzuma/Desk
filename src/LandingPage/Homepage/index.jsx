...
const Index = () => {
  return (
    <div>
      <section className='relative h-[70vh] sm:h-[90vh] w-full bg-white  px-1 sm:px-[3rem] rounded-xl '>
    <div className='parent-home rounded-xl sm:rounded-3xl relative h-full w-full flex flex-col items-center justify-center '>
    <div className='bg-black/50 absolute w-full h-full top-0 left-0 right-0 bottom-0 rounded-3xl '></div>
...
Join our community of hikers and find the perfect trail for get expert advice,detailed trail guides, and suppoer frok adventures at every step
      ...
      <button className='btn relative flex flex-col items-center justify-center bg-black h-[3rem] text-lg font-bold w-48 text-white px-3 py-2 rounded-full'>Get Started</button>
